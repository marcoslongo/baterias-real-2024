  ...
  return (
    <section className="py-16">
      <div className="container py-10 flex flex-col gap-8">
        <h2 className="text-center text-5xl font-semibold flex justify-center gap-1">Baterias Real. Seu Destino, <span className="font-bold flex items-center">Nossa Energia!<BsLightningFill className="text-[#DF0209]" /></span></h2>
