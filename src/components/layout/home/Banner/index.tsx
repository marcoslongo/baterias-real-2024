      ...
      <div className="container h-full flex items-start lg:items-center">
        <div className="w-full lg:w-[52%] xl:w-3/5 relative z-30 flex gap-6 flex-col items-center lg:items-start mt-12 lg:mt-0">
          ...
          <div className="flex justify-center md:justify-start">
            <Link href="/seja-um-revendedor" className="flex bg-[#DF0209] transition font-semibold text-white px-4 py-2 items-center gap-2 rounded-md border border-[#DF0209] hover:bg-transparent hover:text-[#DF0209]">
              Seja um Revendedor  
